...
ki = Key(
    0x18E14A7B6A307F426A94F8114701E7C8E774E7F9A47E2C2035DB29A206321725, compressed=False
)
...
transaction_input = Input(
    prev_txid=txid, output_n=0, keys=ki.public_byte, compressed=ki.compressed
)
...
ki = Key(
    "cRMjy1LLMPsVU4uaAt3br8Ft5vdJLx6prY4Sx7WjPARrpYAnVEkV", network="testnet"
)  # Private key for import
transaction_input = Input(
    prev_txid="adee8bdd011f60e52949b65b069ff9f19fc220815fdc1a6034613ed1f6b775f1",
    output_n=1,
    keys=ki.public(),
    network="testnet",
)
...
output_addresses = [
    "mn6xJw1Cp2gLcSSQAYPnX4G2M6GARGyX5j",
    "n3pdL33MgTA316odzeydhNrcKXdu6jy8ry",
    "n1Bq89KaJrcaXEMUEsDSyhKHfTGi8mkfRJ",
    "mrqYnxFPcf6u5xkEfmA3dxQzjB7ZcPgtTq",
...
transaction_outputs = [
    Output(135000000, address="mkzpsGwaUU7rYzrDZZVXFne7dXEeo6Zpw2", network="testnet")
]
t = Transaction(outputs=transaction_outputs, network="testnet")
transaction_inputs = [
    (
        "f3d9b08dbd873631aaca66a1d18342ba24a22437ea107805405f6bedd3851618",
        0,
...
rawtx = (
    "0100000001eccf7e3034189b851985d871f91384b8ee357cd47c3024736e5676eb2debb3f2010000006a47304402202a72b6a53"
...
rawtx = (
    "0100000001181685d3ed6b5f40057810ea3724a224ba4283d1a166caaa313687bd8db0d9f300000000fdfd0000473044022026c"
...
rawtx = (
    "01000000000102d6ff09fefa22fabd07306d9185da3cdefbed208d949fdc9985a164dd2ddde097000000006a4730440220385bd"
